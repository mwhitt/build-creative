...
require $incdir .'meta/seo-meta.php';
...
function zilla_register_required_plugins() {
  ...
  $theme_text_domain = 'frame';

  /**
   * Config settings
   */
  $config = array(
    'domain'           => 'frame',                     // Text domain - likely want to be the same as your theme.
    ...
    'strings'          => array(
      'page_title'                     => __( 'Install Required Plugins', 'frame' ),
      'menu_title'                     => __( 'Install Plugins', 'frame' ),
      'installing'                     => __( 'Installing Plugin: %s', 'zilla' ), // %1$s = plugin name
      'oops'                           => __( 'Something went wrong with the plugin API.', 'frame' ),
      ...
      'return'                         => __( 'Return to Required Plugins Installer', 'frame' ),
      'plugin_activated'               => __( 'Plugin activated successfully.', 'frame' ),
      'complete'                       => __( 'All plugins installed and activated successfully. %s', 'frame' ), // %s = dashboard link
